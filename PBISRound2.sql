...
SPED = STU.U2,
MAP_Lexile = ISNULL ((SELECT TOP (1) OT AS score FROM TST WHERE (DEL = 0) AND (PID = stu.ID) AND (ID = 'MAP') AND (PT = 1)) ORDER BY TD DESC ),''),
MAP_ELA = ISNULL ((SELECT TOP (1) SS AS score FROM TST WHERE (DEL = 0) AND (PID = stu.ID) AND (ID = 'MAP') AND (PT = 1)) ORDER BY TD DESC ),''),
MAP_Math = ISNULL ((SELECT TOP (1) SS AS score FROM TST WHERE (DEL = 0) AND (PID = stu.ID) AND (ID = 'MAP') AND (PT = 20)) ORDER BY TD DESC ),''),
...
-- AND STU.ID IN (61646, 103696,61668)
