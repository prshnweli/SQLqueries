...
'Complete' = (SELECT SUM(CC) FROM HIS WHERE STU.ID = HIS.PID AND HIS.TE = 0 AND HIS.YR = 19),
'Attempted' = (SELECT SUM(CR) FROM HIS WHERE STU.ID = HIS.PID AND HIS.TE = 0 AND HIS.YR = 19)
FROM ATT
...
AND ATT.DT > '8/14/2019'
AND ATT.DT < '9/28/2019'
